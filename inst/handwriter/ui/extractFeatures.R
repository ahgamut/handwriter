...
tabPanel(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      fluidRow(
        column(width = 2, offset = 1, actionButton("features_processhandwriting", "Process Document")),
      ...
      br(),
      fluidRow(
        column(width = 2, offset = 1, actionButton("process_batch", "Process Batch")),
    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          hr(), br(),
          fluidRow(
            style = "background-color:#ECECEC;", column(2, strong(id = "document_image", "image")),
          ...
          fluidRow(
            column(2, strong(id = "document_thin", "thin")),
          ...
          hr(),
          fluidRow(
            style = "background-color:#ECECEC;", column(2, strong(id = "document_nodes", "nodes")),
          ...
          fluidRow(
            column(2, strong(id = "document_connectingNodes", "connectingNodes")),
          ...
          fluidRow(
            style = "background-color:#ECECEC;", column(2, strong(id = "document_terminalNodes", "terminalNodes")),
          ...
          fluidRow(
            column(2, strong(id = "document_breakPoints", "breakPoints")),
