...
// addToFeatures
List addToFeatures(List FeatureSet, List LetterList,
                   IntegerVector vectorDims);
RcppExport SEXP _handwriter_addToFeatures(SEXP FeatureSetSEXP,
                                          SEXP LetterListSEXP,
                                          SEXP vectorDimsSEXP)
{
    BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter<IntegerVector>::type vectorDims(
        vectorDimsSEXP);
    rcpp_result_gen =
        Rcpp::wrap(addToFeatures(FeatureSet, LetterList, vectorDims));
    return rcpp_result_gen;
    END_RCPP
}
// rgba2rgb
...
static const R_CallMethodDef CallEntries[] = {
    {"_handwriter_cleanBinaryImage", (DL_FUNC)&_handwriter_cleanBinaryImage,
     1},
