...
posteriopredictive_wrappedcauchy <- function(modeldat, samps, newdocs, numCores = 2, logdocname = "postpred_log") {
  # mcmc_samples = coda samples c('theta')
  ...
  for (i in 1:modeldat$W) {
    # i is writer, j is graph
